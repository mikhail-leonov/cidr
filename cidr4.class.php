...
class CIDR4 {
	 ...
	 * Usage:
	 *     CIDR4::countSetBits(ip2long('255.255.252.0'));
	 * Result:
	 *     int(22)
	 ...
	 * Usage:
	 *     CIDR4::validNetMask('255.255.252.0');
	 *     CIDR4::validNetMask('127.0.0.1');
	 * Result:
	 *     bool(true)
	 *     bool(false)
	 ...
	 * Usage:
	 *     CIDR4::maskToCIDR('255.255.252.0');
	 * Result:
	 *     int(22)
	 * @param $netmask String a 1pv4 formatted ip address.
	 * @access public
	 ...
	 * block.
	 * Usage:
	 *     CIDR4::alignedCIDR('127.0.0.1','255.255.252.0');
	 * Result:
	 ...
	 * Usage:
	 *     CIDR4::IPisWithinCIDR('127.0.0.33','127.0.0.1/24');
	 *     CIDR4::IPisWithinCIDR('127.0.0.33','127.0.0.1/27');
	 * Result: 
	 *     bool(true)
	 *     bool(false)
	 * @param $ipinput String a IPv4 formatted ip address.
	 ...
	 * Usage:
	 *     CIDR4::maxBlock("127.0.0.1");
	 *     CIDR4::maxBlock("127.0.0.0");
	 * Result:
	 *     int(32)
	 *     int(8)
	 * @param $ipinput String a IPv4 formatted ip address.
	 ...
	 * ip addresses.
	 * Usage:
	 *     CIDR4::rangeToCIDRList("127.0.0.1","127.0.0.34");
	 * Result:
	 *     array(7) { 
	 ...
	 * Usage:
	 *     CIDR4::cidrToRange("127.0.0.128/25");
	 * Result:
         *     array(2) {
   ...
   /**
     ...
     * Usage:
     *     CIDR4::cidrToList("127.0.0.128/32");
     * Result:
         *     array(2) {
         *       [0]=> string(11) "127.0.0.128"
