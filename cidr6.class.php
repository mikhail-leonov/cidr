...
class CIDR6
{
    ...
    public static function cidr_intersect($ip, $cidr)
    {
        ...
        list($lo,$hi)   = array_map($map, CIDR6::cidr_to_range($ip));
        list($min,$max) = array_map($map, CIDR6::cidr_to_range($cidr));
    ...
    public static function optimize_cidrlist($cidrs, $maxPrefix = 32)
    {
        ...
        $cidrs = array_map(function($o){ return $o instanceof CIDR ? $o : new CIDR6($o); }, $cidrs);
    ...
    public static function cidr_sort($cidrs, $callback = null)
    {
        ...
        if ($callback === null) {
            ...
            throw new \InvalidArgumentException("Invalid callback in CIDR6::cidr_sort, expected Closure, got " . gettype($callback));
        }
	...
	public static function rangeToCIDRList( $ip1, $ip2 ) {
		return CIDR6::range_to_cidrlist( $ip1, $ip2 );
	}
	public static function cidrToRange( $cidr ) {
		return CIDR6::cidr_to_range( $cidr );
	}
